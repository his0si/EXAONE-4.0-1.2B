"""
Experiment 5: W8A8 Hyperparameter Sweep
Low risk, incremental improvement. Tests dampening, calibration size, sequence length.
"""
import os
import sys
import json
...
EXPERIMENTS = {
    "w8a8_d015_c2048_s1024": {
        "num_samples": 2048, "max_seq_length": 1024, "dampening_frac": 0.015,
        "include_manta": True, "manta_ratio": 0.5,
    },
    "w8a8_d02_c3072_s512": {
        "num_samples": 3072, "max_seq_length": 512, "dampening_frac": 0.02,
        "include_manta": True, "manta_ratio": 0.5,
    },
    "w8a8_d02_c4096_s512": {
        "num_samples": 4096, "max_seq_length": 512, "dampening_frac": 0.02,
        "include_manta": True, "manta_ratio": 0.5,
    },
    "w8a8_d025_c2048_s512": {
        "num_samples": 2048, "max_seq_length": 512, "dampening_frac": 0.025,
        "include_manta": True, "manta_ratio": 0.5,
    },
}
...
def run_experiment(name, config):
    ...
    print(f"[INFO] W8A8 GPTQ (damp={config['dampening_frac']}, cal={config['num_samples']}, seq={config['max_seq_length']})...")
    recipe = [
        GPTQModifier(
            scheme="W8A8",
            targets=["Linear"],
