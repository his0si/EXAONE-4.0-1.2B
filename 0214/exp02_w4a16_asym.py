"""
Experiment 2: W4A16_ASYM (Asymmetric 4-bit) + Korean Calibration
Medium risk, high reward. Asymmetric preserves more information.
vLLM MarlinLinearKernel supports uint4+zero_points.
"""
import os
import sys
import json
...
def run_experiment(name, config):
    ...
    print(f"[INFO] {config['scheme']} GPTQ quantization (damp={config['dampening_frac']})...")
    recipe = [
        GPTQModifier(
