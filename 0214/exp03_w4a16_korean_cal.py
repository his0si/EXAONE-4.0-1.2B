"""
Experiment 3: W4A16 Symmetric + Korean Calibration
Medium risk. Tests if Korean calibration data prevents PerfNorm collapse.
"""
import os
import sys
import json
...
def run_experiment(name, config):
    ...
    cal_ds = load_korean_calibration(
        ...
        include_manta=config.get("include_manta", False),
